...
public final class FrmProducto extends javax.swing.JInternalFrame {
    ...
    public FrmProducto() {
        initComponents();
        inhabilitar();
        mostrar("nombre_producto",txtBuscar.getText());
...
//        lblSalir.setEnabled(true);
        ...
        txtUbicacion_bodega.setText("BOTICA 'MATHIEU-FARMA'");
    }
    ...
    public void mostrar(String campo, String buscar) {

        try {
            DefaultTableModel modelo;
            Fproducto funcion = new Fproducto();
            modelo = funcion.mostrar(campo, buscar);
...
//            lblTotalRegistros.setText("CANTIDAD DE REGISTROS : " + Integer.toString(funcion.totalRegistros));
    ...
    public void mostrarExportar(String buscar) {
        try {
            DefaultTableModel modelo;
            Fproducto funcion = new Fproducto();
            if(cboSelec.getSelectedIndex()==0){
                modelo=funcion.mostrar("nombre_producto",txtBuscar.getText());
            }else{
                modelo=funcion.mostrar("cod_producto",txtBuscar.getText());
            }
            jTabla.setModel(modelo);
            // ocultar_columnas();
            //  lblTotalRegistros.setText("Cantidad de Registros : " + Integer.toString(funcion.totalRegistros));
    ...
    private void initComponents() {
        ...
        txtDescripcion_producto.setBackground(new java.awt.Color(102, 255, 204));
        ...
        txtPrecio_compra.setBackground(new java.awt.Color(102, 255, 204));
        ...
        txtUbicacion_bodega.setBackground(new java.awt.Color(102, 255, 204));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cboUnidad_producto, 0, 457, Short.MAX_VALUE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        if(cboSelec.getSelectedIndex()==0){
            mostrar("nombre_producto",txtBuscar.getText());
             ...
             mostrar("cod_producto",txtBuscar.getText());
        }
